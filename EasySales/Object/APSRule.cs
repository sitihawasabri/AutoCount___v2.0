...
namespace EasySales.Object
{
    public class APSRule
    {
        ...
        public int DisableProduct { get; set; }
        public ArrayList WarehouseList { get; set; }
        public int loopCount { get; set; }
        public Dictionary<string,string> WarehousePairList { get; set; }
        public Dictionary<string,string> WarehouseLocationList { get; set; }
        public string Query { get; set; }
        public ArrayList Include { get; set; }
        public ArrayList Exclude { get; set; }
        public ArrayList OrderQuery { get; set; } //testing 
        public APSRule() { }
