...
namespace EasySales.Job
{
    ...
    public class JobAPSStockCategorySync : IJob
    {
        public void Execute()
        {
            this.Run();
        ...
        public void Run()
        {
            try
            {
                Thread thread = new Thread(p =>
                {
                    ...
                    slog.action_identifier = Constants.Action_APSStockCategorySync;                                 
                    ...
                    logger.message = "APS stock category sync is running";
                    logger.Broadcast();
                    ...
                    mysql_list.Iterate<DpprMySQLconfig>((mysql_config, index) =>
                    {
                        ...
                        dynamic jsonRule = checkDB.CheckTablesExist().GetSettingByTableName("cms_product_category");
                        ...
                        if (jsonRule != null)
                        {
                            foreach (var key in jsonRule)
                            {
                                ...
                                {
                                    string query = "SELECT varItemTypeNm, varItemTypeDesc FROM Inv_ItemTypeTbl";
                        ...
                        mssql_rule.Iterate<APSRule>((database, idx) =>
                        {
                            ...
                            queryResult.Iterate<Dictionary<string, string>>((map, i) =>
                            {
                                ...
                                if (valueString.Count % 2000 == 0)
                                {
                                    ...
                                    mysql.Message("Product Category: " + insertQuery);
                    ...
                    logger.message = "APS stock category sync finished in (" + ts.TotalSeconds.ToString("F") + " seconds)";
                    logger.Broadcast();
            ...
            catch (ThreadAbortException e)
            {
                ...
                {
                    file_name = "JobAPSStockCategorySync",
                    exception = e.Message,
